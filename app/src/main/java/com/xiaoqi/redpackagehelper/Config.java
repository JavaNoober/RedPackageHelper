...
public class Config {
    ...
    public static final String ACTION_QIANGHONGBAO_SERVICE_DISCONNECT = "com.xiaoqi.redpackagehelper.ACCESSBILITY_DISCONNECT";
    public static final String ACTION_QIANGHONGBAO_SERVICE_CONNECT = "com.xiaoqi.redpackagehelper.ACCESSBILITY_CONNECT";

    public static final String ACTION_NOTIFY_LISTENER_SERVICE_DISCONNECT = "com.xiaoqi.redpackagehelper.NOTIFY_LISTENER_DISCONNECT";
    public static final String ACTION_NOTIFY_LISTENER_SERVICE_CONNECT = "com.xiaoqi.redpackagehelper.NOTIFY_LISTENER_CONNECT";
